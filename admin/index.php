...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-dark bg-black bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'applications')? 'active' : '' ?>" href="./?page=applications">Applications</a>
                    </li>
                    <li class="nav-item">
